...
const PERMISSION_GROUPS: Array<{
  ...
  },
  {
    ...
    items: [
      ...
      { key: 'can_associate_diagnosis',         label: 'Association au dossier patient', description: 'Enregistrer un diagnostic CIM sur le dossier du patient ou la consultation en cours.' },
