              ...
              >
                ...
                <div className="flex-1 min-w-0">
                  ...
                  {conv.partnerSpeciality && (
                    <p className="text-[10px] text-[#006685] font-semibold uppercase tracking-wide leading-tight">{conv.partnerSpeciality}</p>
                  )}
                ...
                filteredPracts.map(p => (
                  ...
                  >
                    ...
                    <div className="flex-1 min-w-0">
                      ...
                      <p className="text-xs text-[#006685] font-semibold uppercase tracking-wide">{p.speciality}</p>
                    </div>
          ...
          <div className="flex items-center gap-3 px-5 py-3.5 border-b border-slate-100/60" style={{ backgroundColor: 'rgba(255,255,255,0.70)' }}>
            ...
            <div className="flex-1">
              ...
              {activeConv.partnerSpeciality ? (
                <p className="text-[10px] text-[#006685] font-semibold uppercase tracking-wide">{activeConv.partnerSpeciality}</p>
              ) : (
