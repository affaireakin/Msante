...
// lien email — un lien vers msante://reset-password ne peut pas s'ouvrir
// depuis Expo Go (qui ne comprend que son propre schéma exp://), ce qui
// rendait "mot de passe oublié" impossible à tester sans un vrai build.
      ...
      <View style={{ flex: 1, paddingHorizontal: 24 }}>
        ...
        <View style={{ marginTop: 40, marginBottom: 36 }}>
          ...
          <View style={{ width: 52, height: 52, borderRadius: 14, backgroundColor: '#e5eeff', alignItems: 'center', justifyContent: 'center', marginBottom: 16 }}>
            <MaterialIcons name="lock-reset" size={26} color="#82d8ff" />
          </View>
