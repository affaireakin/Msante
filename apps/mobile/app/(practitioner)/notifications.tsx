...
const TYPE_ICONS: Record<string, { name: React.ComponentProps<typeof MaterialIcons>['name']; color: string; bg: string }> = {
  practitioner_approved:    { name: 'verified',        color: '#1d7a3a', bg: '#d1fae5' },
  practitioner_rejected:    { name: 'error',           color: '#ba1a1a', bg: '#ffdad6' },
  documents_submitted:      { name: 'description',      color: '#82d8ff', bg: '#e5eeff' },
      ...
      {isLoading ? (
        ...
        <View style={{ flex: 1, alignItems: 'center', justifyContent: 'center', gap: 12, paddingHorizontal: 40 }}>
          ...
          <Text style={{ fontSize: 13, color: '#6f787e', fontFamily: 'Manrope', textAlign: 'center', lineHeight: 20 }}>
            Vous serez notifié de vos rendez-vous et de l&apos;état de votre dossier.
          </Text>
        </View>
      ) : (
        <FlatList
